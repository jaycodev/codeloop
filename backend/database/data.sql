...
('GSAP desde Cero', 'Aprende a usar GSAP para crear animaciones increíbles en tu página', 17, 200.00, 'https://midu.dev/courses/gsap-desde-cero.webp'),
('Animaciones en CSS', 'Domina las animaciones CSS desde cero y sorpréndete con efectos que no requieren JavaScript', 18, 180.00, 'https://midu.dev/courses/animaciones-en-css.webp'),
('Curso Intensivo de MCP', 'Aprende a crear, configurar e integrar MCPs para conectar LLMs con APIs', 19, 120.00, 'https://midu.dev/courses/og-curso-intensivo-mcp.webp'),
('Promesas en JavaScript', 'Aprende y domina las promesas en JavaScript para trabajar con asincronía y manejar errores de forma efectiva', 20, 250.00, 'https://midu.dev/courses/og-promesas-javascript.webp'),
('Scraping con Python', 'Aprende a extraer datos de la web con Python utilizando diferentes librerías como BeautifulSoup, Requests y Playwright. Aprende sobre CAPTCHAs, como saltearlas y mucho más', 16, 100.00, 'https://midu.dev/courses/iniciacion-al-scraping-con-python.webp'),
('JavaScript (ES2023 & ES2024)', '¡No te quedes atrás con tus conocimientos de JavaScript! Descubre los nuevos métodos de Array, nuevos operadores lógicos, métodos de Promesas para tratar la asincronía y cómo optimizar tu código con lo último de JS', 17, 300.00, 'https://midu.dev/courses/ultimas-novedades-javascript.webp'),
('CSS Grid', 'Aprende a crear diseños web modernos y responsivos utilizando CSS Grid. Desde la base hasta técnicas avanzadas', 18, 160.00, 'https://midu.dev/courses/curso-de-css-grid.webp'),
